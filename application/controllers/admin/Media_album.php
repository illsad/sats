...
class Media_album extends CI_Controller {
    ...
    public function listAjax($offset = 1) {
        $this->load->library('pagination');
        $keyword = '';
        $this->Mediaalbum_model->limit = $limit = 20;
        ...
        $data['pages'] = $this->Mediaalbum_model->createPage($offset, $this->Mediaalbum_model->limit, $total);
        $data['type'] = 'album';
