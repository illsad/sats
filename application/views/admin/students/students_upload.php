            ...
            <div class="col-md-12">
                <div class="box-body">
                       ...
                       <body><br>
                        ...
                        <p>Penginputan data Siswa bisa dilakukan dengan mengcopy data dari file Ms. Excel. Format file excel harus sesuai kebutuhan aplikasi. Silahkan download formatnya <a href="<?=site_url('admin/students/download');?>"><span class="label label-success">Disini</span></a>
                            <br><br>
