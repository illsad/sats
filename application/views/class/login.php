                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <div class="card card-login">
                                ...
                                <div class="card-content">
                                    <?php echo form_open('class/auth/login'); ?>
                                    <?php
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-warning btn-wd btn-lg">Login</button>  
                                </div>
                            </div>
                            <?php echo form_close(); ?>
                            <div class="text-xs-center">
                            <center><span class="btn btn-warning rounded btn-sm">Copyright &copy; <script>document.write(new Date().getFullYear())</script> All rights reserved</span>
                            </div></center>
                        </div>
                    </div>
                </div>
