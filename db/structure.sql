...
CREATE TABLE IF NOT EXISTS `teachers` (
  ...
  `teacher_nuptk` VARCHAR(100) NULL DEFAULT NULL,
  `teacher_name` VARCHAR(255) NULL,
  `teacher_gender` ENUM('L','P') NULL,
  `teacher_pob` VARCHAR(50) NULL,
  `teacher_dob` DATE NULL,
  `teacher_religion` ENUM('Islam','Kristen','Protestan','Budha','Hindu','Konghucu') NULL,
...
CREATE TABLE IF NOT EXISTS `present` (
  ...
  `present_type` ENUM('Hadir', 'Izin', 'Sakit', 'Alfa') NULL,
